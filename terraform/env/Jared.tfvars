...
## default: bootstrap
bootstrap_tfstate_bucket_name = "bootstrap-bucket-tfstate-i11"

## ##unique## The name of the COS bucket name for bootstrap(kms) ##unique##
## default: bootstrap
bootstrap_hpcskey_bucket_name = "bootstrap-bucket-kms-i11"
...
## default:*****THIS IS THE NAME OF THE KMS SERVER CREATED DURING BOOTSTRAP**** ("key_protect_name_prefix"+"key_protect_label")
...
## default:
mgmt_kms_key_name = "mgnt-key-itq"
...
## default: cos 
mgmt_cos_label = "mgmt-cos-itq1"

## ## unique ## The prefix of the management resources ## unique ##
## default: devmgmt
mgmt_name_prefix = "gq-mgmt-itq1"
...
## default:
workload_flow_log_bucket_name = "wks-itq1"
workload2_flow_log_bucket_name = "wkd-itq1"
workload3_flow_log_bucket_name = "wkp-itq1"
...
## default: cos ##unique##
workload_cos_label = "wk-csable-cos-itq1"
workload2_cos_label = "wk-dev-cos-itq1"
workload3_cos_label = "wk-prod-cos-itq1"
...
workload_name_prefix = "gq1-itq-wk-csable"
workload2_name_prefix = "gq1-itq-wk-dev"
workload3_name_prefix = "gq1-itq-wk-prod"
